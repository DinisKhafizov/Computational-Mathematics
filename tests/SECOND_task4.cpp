...
TEST(homework_2, num_4) {
    ...
    std::cout << "\033[32mNewton method with shooting\n\033[0m"
              ...
              << "\ny(e + 1) = "
              << result[188 * 2] + (t[125] + M_E) * log(t[188] + M_E)
              << "\ny(e + 1.5) = "
              << result[250 * 2] + (t[125] + M_E) * log(t[250] + M_E)
              << "\ny(e + 2) = "
              << result[313 * 2] + (t[125] + M_E) * log(t[313] + M_E)
              << "\ny(e + 2.5) = "
              << result[375 * 2] + (t[125] + M_E) * log(t[375] + M_E)
              << std::endl << std::endl;
    ...
    std::cout << "\033[32mNewton method with sweep\n\033[0m"
              ...
              << "\ny(e + 1) = "
              << result[188] + (t[125] + M_E) * log(t[188] + M_E)
              << "\ny(e + 1.5) = "
              << result[250] + (t[125] + M_E) * log(t[250] + M_E)
              << "\ny(e + 2) = "
              << result[313] + (t[125] + M_E) * log(t[313] + M_E)
              << "\ny(e + 2.5) = "
              << result[375] + (t[125] + M_E) * log(t[375] + M_E)
              << std::endl << std::endl;
}